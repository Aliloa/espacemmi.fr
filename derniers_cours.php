...
<head>
    ...
    <title>Espace MMI | Vos derniers cours</title>
    <link rel='icon' href='img/favicon.png'>
    <link rel='stylesheet' href='css/style_navigation.css'>
    <link rel='stylesheet' href='css/style_accueil.css'>
    <link rel='stylesheet' href='css/style_derniers_cours.css'>
    ...
    <main>
        ...
        <div class='container'>
            ...
            <div class="bloc-3-bis">
                ...
                <h2>Vos derniers cours ajoutés</h2>
                ...
                <div class="ajt-cours">
                    ...
                    foreach ($resultat as $cours) {
                        ...
                        echo "<div class='cours'>
                                        <a href='{$chemindoc}' target='_blank'><h3>{$cours["cours"]}</h3></a>
