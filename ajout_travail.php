...
<body>
    ...
    <main>
        ...
        <nav class="fda" aria-label="Breadcrumb">
            ...
            <h1 class="h1">Ajouter un travail à faire</h1>

            <form class="ajouter" action="traite_travail.php" method="POST">
               

                <label for="travail">Travail</label><br>
                <textarea name="travail" cols="30" rows="10" required></textarea><br>
